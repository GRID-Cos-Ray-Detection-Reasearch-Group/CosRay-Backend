...
class IoTDBPathTest(SimpleTestCase):
    ...
    def test_ingest_muon_packet_writes_to_muon_path(self, mock_get_pool) -> None:  # noqa: ANN001
    ...
    @patch("core.services.get_iotdb_pool")
    def test_ingest_timeline_packet_writes_to_timeline_path(self, mock_get_pool) -> None:  # noqa: ANN001
        mock_session = MagicMock()
        mock_pool = MagicMock()
        mock_pool.get_session.return_value = mock_session
        mock_get_pool.return_value = mock_pool
